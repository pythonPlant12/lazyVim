...
hl(0, "htmlTagName",        { fg = palette.blue })
...
hl(0, "NeoTreeGitAdded",            { fg = "#6AAB6A" })
hl(0, "NeoTreeGitUntracked",        { fg = "#6AAB6A" })
hl(0, "NeoTreeGitModified",         { fg = "#B8865A" })
hl(0, "NeoTreeGitConflict",         { fg = "#B85C5C" })
hl(0, "NeoTreeGitDeleted",          { fg = "#B85C5C" })
hl(0, "NeoTreeGitIgnored",          { fg = palette.muted })
hl(0, "NeoTreeGitRenamed",          { fg = "#9B87C4" })
hl(0, "NeoTreeGitStaged",           { fg = "#6AAB6A" })
