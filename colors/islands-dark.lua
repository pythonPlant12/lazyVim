...
hl(0, "@variable.parameter", { fg = "#A87EC8" })
hl(0, "@variable.parameter.builtin", { fg = "#A87EC8" })
hl(0, "@lsp.type.parameter", { fg = "#A87EC8" })
hl(0, "@lsp.type.parameter.python", { fg = "#A87EC8" })
hl(0, "@lsp.typemod.parameter.declaration", { fg = "#A87EC8" })
hl(0, "@lsp.typemod.parameter.declaration.python", { fg = "#A87EC8" })
hl(0, "@lsp.typemod.variable.parameter", { fg = "#A87EC8" })
hl(0, "@lsp.typemod.variable.parameter.python", { fg = "#A87EC8" })
...
hl(0, "@function.special",            { fg = "#C77DBB" })
hl(0, "@function.special.typescript", { fg = "#C77DBB" })
hl(0, "@function.special.javascript", { fg = "#C77DBB" })
hl(0, "@function.special.vue",        { fg = "#C77DBB" })
...
hl(0, "@lsp.type.typeParameter",     { fg = "#A87EC8" })
