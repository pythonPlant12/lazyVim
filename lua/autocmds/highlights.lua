...
local function is_rose_pine_light_theme()
  local cs = vim.g.colors_name or ""
  return cs == "rose-pine-dawn" or (cs == "rose-pine" and vim.o.background == "light")
end

local function apply_rose_pine_light_hl()
  if not is_rose_pine_light_theme() then return end
...
local function apply_custom_hl()
  ...
  -- match the color of the element itself; fall back to the generic aliases for
