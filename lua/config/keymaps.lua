...
vim.keymap.set(
  ...
  "<C-l>",
  "<C-e><CR>",
  { noremap = true, silent = true, desc = "Ctrl+L: Dismiss completion and new line" }
)
...
vim.keymap.set(
  ...
  { noremap = true, silent = true, desc = "Toggle selection comment" }
)
...
vim.keymap.set("n", "<leader>T", "zc", { noremap = true, silent = true, desc = "Toggle code folding" })
...
vim.keymap.set(
  ...
  { noremap = true, silent = true, desc = "Preview git hunk diff" }
)
vim.keymap.set(
  "n",
  "<leader>gr",
  ":Gitsigns reset_hunk<CR>",
  { noremap = true, silent = true, desc = "Reset git hunk (undo changes)" }
)
vim.keymap.set(
  "n",
  "<leader>gb",
  ":Gitsigns toggle_current_line_blame<CR>",
  { noremap = true, silent = true, desc = "Toggle git blame for current line" }
)
...
vim.keymap.set(
  ...
  "<leader>gz",
  ":Gitsigns reset_hunk<CR>",
  { noremap = true, silent = true, desc = "Revert current git hunk" }
)
...
vim.keymap.set("n", "<leader>fe", function()
  ...
  if vim.tbl_contains(js_filetypes, filetype) then
    ...
    if filename and filename ~= "" then
      local eslint_cmd = "/Users/nikitalutsai/.nvm/versions/node/v20.18.0/bin/eslint_d --fix "
