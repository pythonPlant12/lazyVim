...
local function apply_custom_hl()
  ...
  hl(0, "TroubleIconMethod",        { fg = "#cba6f7" })
  hl(0, "TroubleIconFunction",      { fg = "#cba6f7" })
  ...
  hl(0, "TroubleIconField",         { fg = "#89b4fa" })
  hl(0, "TroubleIconInterface",     { fg = "#89dceb" })
  hl(0, "TroubleIconModule",        { fg = "#74c7ec" })
  hl(0, "TroubleIconProperty",      { fg = "#b4befe" })
  hl(0, "TroubleIconVariable",      { fg = "#a6e3a1" })
