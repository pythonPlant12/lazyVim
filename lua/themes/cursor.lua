  ...
  ["cursor-dark"] = {
    ...
    lsp  = { bg = "#181818", base = "#626262", on = "#AAA0FA", spinner = "#F1B467", green = "#70B489", yellow = "#F1B467",
      servers = {
        ...
        eslint = "#AAA0FA", ruff = "#F1B467", ruff_lsp = "#F1B467", ty = "#88C0D0",
        jinja_lsp = "#EFB080", ["jinja-lsp"] = "#EFB080",
        rust_analyzer = "#EFB080", ["rust-analyzer"] = "#EFB080",
        bacon_ls = "#E34671", ["bacon-ls"] = "#E34671", jdtls = "#EFB080",
        taplo = "#F8C762", marksman = "#81A1C1", fmt = "#70B489",
      } },
  },
  ...
  ["cursor-light"] = {
    ...
    lsp  = { bg = "#EAEAEA", base = "#999999", on = "#654DC0", spinner = "#A46700", green = "#007041", yellow = "#A46700",
      servers = {
        ...
        eslint = "#654DC0", ruff = "#A46700", ruff_lsp = "#A46700", ty = "#176C74",
        jinja_lsp = "#A8552A", ["jinja-lsp"] = "#A8552A",
        rust_analyzer = "#A8552A", ["rust-analyzer"] = "#A8552A",
        bacon_ls = "#BE1744", ["bacon-ls"] = "#BE1744", jdtls = "#A8552A",
        taplo = "#A46700", marksman = "#2778C1", fmt = "#007041",
      } },
  },
}
...
function M.apply(variant)
  ...
  vim.g.theme_custom_hl = {
    ...
    text = p.fg,
    muted_text = p.muted,
    -- Completion (blink) kind colors mapped to the matching syntax token color,
    -- so a function item is the function color, a class item the type color, etc.
    kind_function = p.func,
    kind_type = p.type,
    kind_variable = p.fg,
    kind_property = p.property,
    kind_constant = p.constant,
    kind_keyword = p.keyword,
    kind_string = p.string,
